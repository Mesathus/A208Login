...
namespace A208Login {
    ...
    public partial class StudentsDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int StudentID, string FirstName, string LastName) {
...
namespace A208Login.StudentsDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([StudentID] = @Original_StudentID) AND ([FirstN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([StudentID], [FirstName], [LastName]) VALUES (@Student" +
                "ID, @FirstName, @LastName);\r\nSELECT StudentID, FirstName, LastName FROM [Table] " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [StudentID] = @StudentID, [FirstName] = @FirstName, [LastName] = @LastName WHERE (([StudentID] = @Original_StudentID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName));
SELECT StudentID, FirstName, LastName FROM [Table] WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::A208Login.Properties.Settings.Default.StudentsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, FirstName, LastName FROM dbo.[Table]";
        ...
        public virtual int Fill(StudentsDataSet.TableDataTable dataTable) {
        ...
        public virtual StudentsDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentsDataSet.TableDataTable dataTable = new StudentsDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentsDataSet.TableDataTable dataTable) {
        ...
        public virtual int Insert(int StudentID, string FirstName, string LastName) {
        ...
        public virtual int Update(int StudentID, string FirstName, string LastName, int Original_StudentID, string Original_FirstName, string Original_LastName) {
