...
namespace A208Login {
    ...
    public partial class AdminsDataSet : global::System.Data.DataSet {
        ...
        public partial class AdminDataTable : global::System.Data.TypedTableBase<AdminRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public AdminRow AddAdminRow(int Id, string Admin, string Password) {
...
namespace A208Login.AdminsDataSetTableAdapters {
    ...
    public partial class AdminTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Admin] WHERE (([Id] = @Original_Id) AND ([Admin] = @Original_Admin) " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Admin] ([Id], [Admin], [Password]) VALUES (@Id, @Admin, @Password);\r" +
                "\nSELECT Id, Admin, Password FROM Admin WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Admin] SET [Id] = @Id, [Admin] = @Admin, [Password] = @Password WHERE (([" +
                "Id] = @Original_Id) AND ([Admin] = @Original_Admin) AND ([Password] = @Original_" +
                "Password));\r\nSELECT Id, Admin, Password FROM Admin WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::A208Login.Properties.Settings.Default.AdminConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Admin, Password\r\nFROM  Admin";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Password\r\nFROM  Admin\r\nWHERE Admin = @name;";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.NVarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "Admin", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int GetData(AdminsDataSet.AdminDataTable dataTable) {
        ...
        public virtual AdminsDataSet.AdminDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdminsDataSet.AdminDataTable dataTable = new AdminsDataSet.AdminDataTable();
        ...
        public virtual int FillBy(AdminsDataSet.AdminDataTable dataTable, string name) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdminsDataSet.AdminDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Admin, string Original_Password) {
        ...
        public virtual int Insert(int Id, string Admin, string Password) {
        ...
        public virtual int Update(int Id, string Admin, string Password, int Original_Id, string Original_Admin, string Original_Password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Admin, string Password, int Original_Id, string Original_Admin, string Original_Password) {
            return this.Update(Original_Id, Admin, Password, Original_Id, Original_Admin, Original_Password);
        }
    }
